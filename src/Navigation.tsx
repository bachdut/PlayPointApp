...
import MyHostedGamesScreen from '../src/screens/MyHostedGamesScreen';
...
const PlayPointsStack = ({ token }: { token: string }) => (
  <Stack.Navigator initialRouteName="PlayPoints">
    ...
    <Stack.Screen 
      name="Host" 
      options={{ headerTitle: 'Host a Game' }} 
    >
      {props => <HostScreen {...props} token={token} />}
    </Stack.Screen>
    <Stack.Screen 
      name="SelectTime" 
      options={{ headerTitle: 'Select a Time' }}
    >
      {props => <SelectTimeScreen {...props} token={token} />}
    </Stack.Screen>
    <Stack.Screen 
      name="GameDetails" 
    ...
    <Stack.Screen 
      name="MyHostedGames" 
      options={{ headerTitle: 'My Hosted Games' }}
    >
      {props => <MyHostedGamesScreen {...props} token={token} />}
    </Stack.Screen>
  </Stack.Navigator>
);
